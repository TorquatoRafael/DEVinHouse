...
const verificaEstacao = (event) => {
  ...
  if (
    ...
    atualizaEstacao({ texto: "Outono", url: "./images/auttum.avif" });
    return;
  }
  ...
  if (
    ...
    atualizaEstacao({ texto: "Inverno", url: "./images/winter.avif" });
    return;
  }
  ...
  if (
    ...
    atualizaEstacao({ texto: "Primavera", url: "./images/spring.avif" });
    return;
  }

  atualizaEstacao({ texto: "Verão", url: "./images/summer.avif" });
};
